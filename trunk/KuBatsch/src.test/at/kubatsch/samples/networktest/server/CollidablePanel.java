...
public class CollidablePanel extends JPanel
{
    ...
    private NetworkControllerServer _networkController;
    public CollidablePanel()
    {
        try
        {
            _networkController = new NetworkControllerServer(25000);
        }
        ...
        _controller.addStateUpdatedHandler(new IEventHandler<EventArgs>()
        {
            ...
            {
                _networkController.setCollidables(_controller.getCollidablesMapping());
                repaint();
            }
        });
