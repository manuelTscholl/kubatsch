 ...
 * filename: PerformancRunner.java
 * project: KuBaTsch
 */
 ...
 *
 */
public class ServerRunner extends JFrame implements WindowListener, ComponentListener
{
    private GamePanel _panel;
    /**
     * Initializes a new instance of the {@link ServerRunner} class.
     */
    public ServerRunner(GamePanel panel)
    {
        setDefaultCloseOperation(EXIT_ON_CLOSE);
        setTitle("Performance Demo Server");
