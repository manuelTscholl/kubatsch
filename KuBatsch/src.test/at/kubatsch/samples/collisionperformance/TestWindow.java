...
/**
 * A testrunner for testing the performance of collision detection. 
...
public class TestWindow extends JFrame
{
     ...
     */
    private static final long serialVersionUID = -4268119072111823516L;
    ...
    public TestWindow()
    {
        ...
        addBallBtn.addActionListener(new ActionListener()
        {
            ...
            public void actionPerformed(ActionEvent e)
            {
                ...
                balls.add(newBall);
                _collidablePanel.addCollidable(newBall);
            }
        });
    ...
    /**
     * The collision performance runners main entry point. 
     * @param args not used. 
     */
